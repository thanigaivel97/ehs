        ...
        <div>
            ...
            <div className="row  padding-10 mt-4 " >
                <div className="col-lg-5 pl-auto pr-auto flex-column-reverse flex-sm-column " style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                    ...
                    {catSlug === 'posters' ? <img src={product.imgUrl[0] ? product.imgUrl[0] : "https://dummyimage.com/400x400/003459/fff.png&text=No+Image+Available"} alt="preprinted sign" className="productCarouselImg "
                        style={{
                            width: ' 100%',
                            objectFit: 'cover'
                        }}
                ...
                <div className="col-lg-3  " style={{ padding: '12px' }} >
                    ...
                    */}
                    ...
                    {catSlug==='poster' ||catSlug==='asset-markings'?null:<div style={{backgroundColor:'transparent',height:'80px'}}></div>}
                    ...
                    <div className="mt-sm-4 " style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', justifySelf: 'flex-end' }}>
                ...
                <div className="col-lg-4  ">
                    ...
                    <div className=" pt-4 pt-sm-0   catTagSKU ">
                        <p><span style={{ fontWeight: "600", lineHeight: '20px' }}>Category: </span>{product.category[0].title}, {product.subCategory[0].title}</p>
                        {
                        ...
                        <p style={{ display: 'flex', lineHeight: '16px' }}><span style={{ fontWeight: "600" }}>SKU: </span>{product.sku}</p>
